...
public:
    AndroidRender(dii_rtc::VideoSinkInterface<cricket::VideoFrame> *render){
...
private:
    dii_rtc::VideoSinkInterface<cricket::VideoFrame>	*video_renderer_;
};
...
VideoRenderer* VideoRenderer::CreatePlatformRenderer(const void* hwnd,
                                     ...
                                     size_t height)
{
    AndroidRender* render = new AndroidRender((dii_rtc::VideoSinkInterface<cricket::VideoFrame>*)hwnd);
