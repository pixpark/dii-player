...
using dii_media_kit::NativeHandleBuffer;
...
void Matrix::Rotate(dii_media_kit::VideoRotation rotation) {
  ...
  switch (rotation) {
    case dii_media_kit::kVideoRotation_0:
      break;
    case dii_media_kit::kVideoRotation_90: {
    ...
    case dii_media_kit::kVideoRotation_180: {
    ...
    case dii_media_kit::kVideoRotation_270: {
...
AndroidTextureBuffer::AndroidTextureBuffer(
    ...
    : dii_media_kit::NativeHandleBuffer(&native_handle_, width, height),
...
dii_rtc::scoped_refptr<dii_media_kit::VideoFrameBuffer>
AndroidTextureBuffer::NativeToI420Buffer() {
  ...
  std::unique_ptr<uint8_t, dii_media_kit::AlignedFreeDeleter> yuv_data(
      static_cast<uint8_t*>(dii_media_kit::AlignedMalloc(size, kBufferAlignment)));
  ...
  dii_rtc::scoped_refptr<dii_media_kit::VideoFrameBuffer> copy =
    new dii_rtc::RefCountedObject<dii_media_kit::WrappedI420Buffer>(
        width(), height(),
        y_data, stride,
        u_data, stride,
        v_data, stride,
        dii_rtc::Bind(&dii_media_kit::AlignedFree, yuv_data.release()));
...
dii_rtc::scoped_refptr<AndroidTextureBuffer>
AndroidTextureBuffer::CropScaleAndRotate(int cropped_width,
  ...
  if (cropped_width == dst_width && cropped_height == dst_height &&
      ...
      rotation == dii_media_kit::kVideoRotation_0) {
    return this;
  }
  ...
  dii_rtc::scoped_refptr<AndroidTextureBuffer> buffer(
      new dii_rtc::RefCountedObject<AndroidTextureBuffer>(
          rotated_width, rotated_height, native_handle_,
          surface_texture_helper_, dii_rtc::KeepRefUntilDone(this)));
