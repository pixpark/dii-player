...
dii_rtc::scoped_refptr<SurfaceTextureHelper> SurfaceTextureHelper::create(
    JNIEnv* jni,
    const char* thread_name,
    jobject j_egl_context) {
  jobject j_surface_texture_helper = jni->CallStaticObjectMethod(
      FindClass(jni, "org/dii/webrtc/SurfaceTextureHelper"),
      GetStaticMethodID(jni, FindClass(jni, "org/dii/webrtc/SurfaceTextureHelper"),
                        "create",
                        "(Ljava/lang/String;Lorg/dii/webrtc/EglBase$Context;)"
                        "Lorg/dii/webrtc/SurfaceTextureHelper;"),
  ...
  if (IsNull(jni, j_surface_texture_helper))
    return nullptr;
  return new dii_rtc::RefCountedObject<SurfaceTextureHelper>(
...
SurfaceTextureHelper::~SurfaceTextureHelper() {
  ...
  jni->CallVoidMethod(
      *j_surface_texture_helper_,
      GetMethodID(jni, FindClass(jni, "org/dii/webrtc/SurfaceTextureHelper"),
                  "dispose", "()V"));
...
SurfaceTextureHelper::CreateTextureFrame(int width, int height,
  ...
  return new dii_rtc::RefCountedObject<AndroidTextureBuffer>(
      width, height, native_handle, *j_surface_texture_helper_,
      dii_rtc::Bind(&SurfaceTextureHelper::ReturnTextureFrame, this));
}
