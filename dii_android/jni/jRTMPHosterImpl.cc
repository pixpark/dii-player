...
void JRTMPHosterImpl::OnRtmpStreamOK()
{
	...
	JNIEnv* jni = ats.env();
	{
		...
		jmethodID j_callJavaMId = dii_media_jni::GetMethodID(jni, m_jClass, "OnRtmpStreamOK", "()V");
...
void JRTMPHosterImpl::OnRtmpStreamReconnecting(int times)
{
	...
	{
		// Get *** callback interface method id
		jmethodID j_callJavaMId = dii_media_jni::GetMethodID(jni, m_jClass, "OnRtmpStreamReconnecting", "(I)V");
		// Callback with params
...
void JRTMPHosterImpl::OnRtmpStreamStatus(int delayMs, int netBand)
{
	...
	{
		// Get *** callback interface method id
		jmethodID j_callJavaMId = dii_media_jni::GetMethodID(jni, m_jClass, "OnRtmpStreamStatus", "(II)V");
		// Callback with params
...
void JRTMPHosterImpl::OnRtmpStreamFailed(int code)
{
	...
	{
		// Get *** callback interface method id
		jmethodID j_callJavaMId = dii_media_jni::GetMethodID(jni, m_jClass, "OnRtmpStreamFailed", "(I)V");
		// Callback with params
...
void JRTMPHosterImpl::OnRtmpStreamClosed()
{
	...
	{
		// Get *** callback interface method id
		jmethodID j_callJavaMId = dii_media_jni::GetMethodID(jni, m_jClass, "OnRtmpStreamClosed", "()V");
		// Callback with params
		jni->CallVoidMethod(m_jJavaObj, j_callJavaMId);
	}
}
