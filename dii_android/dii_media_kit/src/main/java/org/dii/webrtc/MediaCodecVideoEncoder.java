/*
 *  Copyright 2013 The devzhaoyou@dii_media project authors. All Rights Reserved.
 *
...
public class MediaCodecVideoEncoder {
  ...
  // class exposes aims to mimic the dii_media_kit::VideoEncoder API as closely as
  // possibly to minimize the amount of translation work necessary.

  private static final String TAG = "MediaCodecVideoEncoder";

  // Tracks dii_media_kit::VideoCodecType.
  ...
  private boolean isEnableH264HW = false;
  ...
  private static final MediaCodecProperties hisiH264HwProperties = new MediaCodecProperties(
          "OMX.google.", Build.VERSION_CODES.KITKAT, false /* bitrateAdjustmentRequired */);

  private static final MediaCodecProperties[] h264HwList = new MediaCodecProperties[] {
    qcomH264HwProperties, exynosH264HwProperties, rkH264HwProperties, mtkH264HwProperties, hisiH264HwProperties
  };
  ...
  public static void enableH264HwCodec() {
    Logging.w(TAG, "H.264 decoding is disabled by application.");
    hwEncoderDisabledTypes.remove(H264_MIME_TYPE);
  }
