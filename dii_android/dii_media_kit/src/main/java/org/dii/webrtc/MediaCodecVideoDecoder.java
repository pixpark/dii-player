/*
 *  Copyright 2014 The devzhaoyou@dii_media project authors. All Rights Reserved.
 *
...
public class MediaCodecVideoDecoder {
  ...
  // class exposes aims to mimic the dii_media_kit::VideoDecoder API as closely as
  ...
  public static void enableH264HwCodec() {
    Logging.w(TAG, "H.264 decoding is disabled by application.");
    hwDecoderDisabledTypes.remove(H264_MIME_TYPE);
  }
