...
public final class EglBase14 extends EglBase {
  ...
  private void createSurfaceInternal(Object surface) {
    ...
    if (eglSurface == EGL14.EGL_NO_SURFACE) {
      throw new RuntimeException(
              "Failed to create window surface: 0x" + Integer.toHexString(EGL14.eglGetError()) + ", inst_count: " + inst_count);
    }
  }
  ...
  private static EGLContext createEglContext(
    ...
    if (eglContext == EGL14.EGL_NO_CONTEXT) {
      throw new RuntimeException(
              "Failed to create EGL context: 0x" + Integer.toHexString(EGL14.eglGetError()) + ", inst_count: " + inst_count);
    }
    return eglContext;
  }
}
