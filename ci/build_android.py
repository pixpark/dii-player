...
class Builder:
    def __init__(self, upload_dir):      
        ...
        self.CompilePath = os.path.join(self.projectPath, 'dii_android')
        
        #  sdk output dir
        self.lib_output_dir =  os.path.join(self.projectPath, 'dii_android', 'dii_media_kit', 'build', 'libs')
        self.remote_dir = "client/dii-media-kit/android/" + upload_dir
    ...
    def upload_output(self):
        ...
        if os.path.exists(self.lib_output_dir):
            ...
            self.targetFile =  os.path.join(self.lib_output_dir, 'dii_android_' + version + '_' + ts  + '.zip')
