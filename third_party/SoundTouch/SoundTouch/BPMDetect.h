...
////////////////////////////////////////////////////////////////////////////////
    ...
    protected:
        ...
        dii_soundtouch::LONG_SAMPLETYPE decimateSum;
        ...
        dii_soundtouch::FIFOSampleBuffer *buffer;
        ...
        int decimate(dii_soundtouch::SAMPLETYPE *dest,      ///< Destination buffer
            const dii_soundtouch::SAMPLETYPE *src, ///< Source sample buffer
            int numsamples                     ///< Number of source samples.
        );

        /// Calculates amplitude envelope for the buffer of samples.
        /// Result is output to 'samples'.
        void calcEnvelope(dii_soundtouch::SAMPLETYPE *samples,  ///< Pointer to input/output data buffer
    ...
    public:
        ...
        void inputSamples(const dii_soundtouch::SAMPLETYPE *samples,    ///< Pointer to input/working data buffer
            int numSamples                            ///< Number of samples in buffer
        );
