...
class A_AACEncoder : public dii_media_kit::AudioSinkInterface
{
public:
...
protected:
	...
	//* For dii_media_kit::AudioSinkInterface
...
class V_H264Encoder : public dii_rtc::Thread, public dii_rtc::VideoSinkInterface<cricket::VideoFrame> , public EncodedImageCallback
{
public:
...
private:
	...
	dii_rtc::CriticalSection buffer_critsect_;
	dii_rtc::scoped_ptr<VideoRenderFrames> render_buffers_
