...
int ExtractBuffer(const dii_rtc::scoped_refptr<VideoFrameBuffer>& input_frame,
                  size_t size,
                  uint8_t* buffer) {
  assert(buffer);
  if (!input_frame)
  ...
  dii_libyuv::I420Copy(input_frame->DataY(),
                   input_frame->StrideY(),
                   input_frame->DataU(),
                   input_frame->StrideU(),
                   input_frame->DataV(),
...
int ConvertNV12ToRGB565(const uint8_t* src_frame,
  ...
  return dii_libyuv::NV12ToRGB565(yplane, width,
...
int ConvertRGB24ToARGB(const uint8_t* src_frame, uint8_t* dst_frame,
  ...
  if (dst_stride == 0)
    dst_stride = width;
  return dii_libyuv::RGB24ToARGB(src_frame, width,
                             dst_frame, dst_stride,
                             width, height);
}

dii_libyuv::RotationMode ConvertRotationMode(VideoRotation rotation) {
  switch (rotation) {
    case kVideoRotation_0:
      return dii_libyuv::kRotate0;
    case kVideoRotation_90:
      return dii_libyuv::kRotate90;
    case kVideoRotation_180:
      return dii_libyuv::kRotate180;
    case kVideoRotation_270:
      return dii_libyuv::kRotate270;
  }
  assert(false);
  return dii_libyuv::kRotate0;
}
...
int ConvertVideoType(VideoType video_type) {
  switch (video_type) {
    case kUnknown:
      return dii_libyuv::FOURCC_ANY;
    case  kI420:
      return dii_libyuv::FOURCC_I420;
    case kIYUV:  // same as KYV12
    case kYV12:
      return dii_libyuv::FOURCC_YV12;
    case kRGB24:
      return dii_libyuv::FOURCC_24BG;
    case kABGR:
      return dii_libyuv::FOURCC_ABGR;
    case kRGB565:
      return dii_libyuv::FOURCC_RGBP;
    case kYUY2:
      return dii_libyuv::FOURCC_YUY2;
    case kUYVY:
      return dii_libyuv::FOURCC_UYVY;
    case kMJPG:
      return dii_libyuv::FOURCC_MJPG;
    case kNV21:
      return dii_libyuv::FOURCC_NV21;
    case kNV12:
      return dii_libyuv::FOURCC_NV12;
    case kARGB:
      return dii_libyuv::FOURCC_ARGB;
    case kBGRA:
      return dii_libyuv::FOURCC_BGRA;
    case kARGB4444:
      return dii_libyuv::FOURCC_R444;
    case kARGB1555:
      return dii_libyuv::FOURCC_RGBO;
  }
  assert(false);
  return dii_libyuv::FOURCC_ANY;
}
...
int ConvertToI420(VideoType src_video_type,
  ...
  return dii_libyuv::ConvertToI420(
...
int ConvertFromI420(const VideoFrame& src_frame,
                    ...
                    int dst_sample_size,
                    uint8_t* dst_frame) {
  return dii_libyuv::ConvertFromI420(
...
double I420PSNR(const VideoFrame* ref_frame, const VideoFrame* test_frame) {
  ...
  double psnr = dii_libyuv::I420Psnr(ref_frame->video_frame_buffer()->DataY(),
...
double I420SSIM(const VideoFrame* ref_frame, const VideoFrame* test_frame) {
  ...
  return dii_libyuv::I420Ssim(ref_frame->video_frame_buffer()->DataY(),
                          ref_frame->video_frame_buffer()->StrideY(),
                          ref_frame->video_frame_buffer()->DataU(),
                          ref_frame->video_frame_buffer()->StrideU(),
                          ref_frame->video_frame_buffer()->DataV(),
