...
void Testdii_libyuv::SetUp() {
  const std::string input_file_name = dii_media_kit::test::ResourcePath("foreman_cif",
                                                                 "yuv");
...
TEST_F(TestLibYuv, ConvertTest) {
  ...
  int j = 0;
  std::string output_file_name = dii_media_kit::test::OutputPath() +
