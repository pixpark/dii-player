...
dii_rtc::scoped_refptr<I420Buffer> I420BufferPool::CreateBuffer(int width,
                                                            int height) {
  ...
  for (const dii_rtc::scoped_refptr<PooledI420Buffer>& buffer : buffers_) {
  ...
  // Allocate new buffer.
  dii_rtc::scoped_refptr<PooledI420Buffer> buffer =
