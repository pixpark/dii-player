...
typedef dii_rtc::Optional<dii_media_kit::SpsParser::SpsState> OptionalSps;
...
dii_rtc::Optional<SpsParser::SpsState> SpsParser::ParseSps(const uint8_t* data,
                                                       size_t length) {
...
dii_rtc::Optional<SpsParser::SpsState> SpsParser::ParseSpsUpToVui(
    dii_rtc::BitBuffer* buffer) {
