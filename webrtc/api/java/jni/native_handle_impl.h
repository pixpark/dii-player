...
class Matrix {
 public:
  ...
  void Rotate(dii_media_kit::VideoRotation rotation);
...
class AndroidTextureBuffer : public dii_media_kit::NativeHandleBuffer {
 public:
  ...
  dii_rtc::scoped_refptr<AndroidTextureBuffer> CropScaleAndRotate(
      int cropped_width,
      int cropped_height,
      int crop_x,
      int crop_y,
