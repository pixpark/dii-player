...
class AndroidVideoCapturerDelegate : public dii_rtc::RefCountInterface {
 public:
...
class AndroidVideoCapturer : public cricket::VideoCapturer {
 public:
  explicit AndroidVideoCapturer(
      const dii_rtc::scoped_refptr<AndroidVideoCapturerDelegate>& delegate);
 ...
 private:
  ...
  bool running_;
  dii_rtc::scoped_refptr<AndroidVideoCapturerDelegate> delegate_;
