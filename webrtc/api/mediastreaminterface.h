...
class MediaSourceInterface : public dii_rtc::RefCountInterface,
...
class MediaStreamTrackInterface : public dii_rtc::RefCountInterface,
                                  public NotifierInterface {
 public:
  enum TrackState {
    kLive,
...
class VideoTrackSourceInterface
    : public MediaSourceInterface,
      public dii_rtc::VideoSourceInterface<cricket::VideoFrame> {
 public:
  struct Stats {
  ...
  // the encoder.
  virtual dii_rtc::Optional<bool> needs_denoising() const = 0;
...
class VideoTrackInterface
 ...
 public:
  ...
  void AddOrUpdateSink(dii_rtc::VideoSinkInterface<cricket::VideoFrame>* sink,
                       const dii_rtc::VideoSinkWants& wants) override{};
  void RemoveSink(
      dii_rtc::VideoSinkInterface<cricket::VideoFrame>* sink) override{};
...
// statistics.
class AudioProcessorInterface : public dii_rtc::RefCountInterface {
 public:
...
class AudioTrackInterface : public MediaStreamTrackInterface {
 public:
  ...
  virtual dii_rtc::scoped_refptr<AudioProcessorInterface>
...
typedef std::vector<dii_rtc::scoped_refptr<AudioTrackInterface> >
    AudioTrackVector;
typedef std::vector<dii_rtc::scoped_refptr<VideoTrackInterface> >
    VideoTrackVector;

class MediaStreamInterface : public dii_rtc::RefCountInterface,
                             public NotifierInterface {
 public:
  ...
  virtual dii_rtc::scoped_refptr<AudioTrackInterface>
      FindAudioTrack(const std::string& track_id) = 0;
  virtual dii_rtc::scoped_refptr<VideoTrackInterface>
