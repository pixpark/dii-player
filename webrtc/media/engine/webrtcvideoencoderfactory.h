...
class WebRtcVideoEncoderFactory {
 public:
  struct VideoCodec {
    ...
    VideoCodec(dii_media_kit::VideoCodecType t, const std::string& nm, int w, int h,
               int fr)
  ...
  virtual dii_media_kit::VideoEncoder* CreateVideoEncoder(
  ...
  // frames to be delivered via dii_media_kit::VideoEncoder::Encode. This flag is used
  // as the internal_source parameter to
  // dii_media_kit::ViEExternalCodec::RegisterExternalSendCodec.
  virtual bool EncoderTypeHasInternalSource(dii_media_kit::VideoCodecType type) const {
    return false;
  }

  virtual void DestroyVideoEncoder(dii_media_kit::VideoEncoder* encoder) = 0;
};
