...
// dii_media_kit::VideoFrame classes are merged. See
...
class WebRtcVideoFrame : public VideoFrame {
 public:
  ...
  WebRtcVideoFrame(const dii_rtc::scoped_refptr<dii_media_kit::VideoFrameBuffer>& buffer,
  ...
  // time scale as dii_rtc::TimeMicros. However, this method is used by
  ...
  dii_media_kit::VideoRotation rotation() const override { return rotation_; }
 ...
 private:
  ...
  dii_media_kit::VideoRotation rotation_;
