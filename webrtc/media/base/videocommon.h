...
#define FPS_TO_INTERVAL(fps) \
    (fps ? dii_rtc::kNumNanosecsPerSec / fps : \
    dii_rtc::kNumNanosecsPerSec / 10000)
...
struct VideoFormat : VideoFormatPod {
  static const int64_t kMinimumInterval =
      dii_rtc::kNumNanosecsPerSec / 10000;  // 10k fps.
  ...
  static int64_t FpsToInterval(int fps) {
    return fps ? dii_rtc::kNumNanosecsPerSec / fps : kMinimumInterval;
  }
  ...
  static int IntervalToFps(int64_t interval) {
    ...
    return static_cast<int>(dii_rtc::kNumNanosecsPerSec / interval);
  }
  ...
  static float IntervalToFpsFloat(int64_t interval) {
    ...
    return static_cast<float>(dii_rtc::kNumNanosecsPerSec) /
