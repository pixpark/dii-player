/*
 *  Copyright (c) 2004 The devzhaoyou@dii_media project authors. All Rights Reserved.
 *
...
// TODO(nisse): This class duplicates dii_media_kit::VideoFrame. There's
...
class VideoFrame {
 public:
  ...
  virtual const dii_rtc::scoped_refptr<dii_media_kit::VideoFrameBuffer>&
  video_frame_buffer() const = 0;

  // System monotonic clock, same timebase as dii_rtc::TimeMicros().
  ...
  virtual int64_t GetTimeStamp() const {
    return dii_rtc::kNumNanosecsPerMicrosec * timestamp_us();
  }
  virtual void SetTimeStamp(int64_t time_ns) {
    set_timestamp_us(time_ns / dii_rtc::kNumNanosecsPerMicrosec);
  }

  // Indicates the rotation angle in degrees.
  virtual dii_media_kit::VideoRotation rotation() const = 0;
  ...
  // dii_media_kit::VideoFrame merge. To make a copy, use the cricket::WebRtcVideoFrame
  ...
  // cricket::VideoFrame and dii_media_kit::VideoFrame merge, possibly with a helper
  ...
  // TODO(nisse): Deprecated. Should be moved or deleted in the
  // cricket::VideoFrame and dii_media_kit::VideoFrame merge. Use
  // dii_libyuv::ConvertFromI420 directly instead.
  ...
  // dii_media_kit::VideoFrame merge. Validation of sample_size possibly moved to
  // dii_libyuv::ConvertToI420. As an initial step, demote this method to protected
