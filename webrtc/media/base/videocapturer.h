/*
 *  Copyright (c) 2010 The devzhaoyou@dii_media project authors. All Rights Reserved.
 *
...
struct CapturedFrame {
  ...
  dii_media_kit::VideoRotation rotation;  // rotation in degrees of the frame.
...
class VideoCapturer : public sigslot::has_slots<>,
 ...
 public:
  ...
  void RemoveSink(dii_rtc::VideoSinkInterface<cricket::VideoFrame>* sink) override;
 ...
 protected:
  ...
  virtual void OnSinkWantsChanged(const dii_rtc::VideoSinkWants& wants);
  ...
  // monotonic system time (in the same scale as dii_rtc::TimeMicros) when
 ...
 private:
  ...
  dii_rtc::ThreadChecker thread_checker_;
  std::string id_;
  ...
  dii_rtc::VideoBroadcaster broadcaster_;
  bool enable_video_adapter_;
  VideoAdapter video_adapter_;

  dii_rtc::CriticalSection frame_stats_crit_;
  ...
  dii_rtc::TimestampAligner timestamp_aligner_;
