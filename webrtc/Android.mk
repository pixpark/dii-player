...
LOCAL_CPPFLAGS := -std=gnu++11 -frtti -D__UCLIBC__ -DWEBRTC_POSIX -DWEBRTC_LINUX -DWEBRTC_ANDROID -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS
LOCAL_CFLAGS += -DWEBRTC_THREAD_RR -DWEBRTC_INCLUDE_INTERNAL_AUDIO_DEVICE -DWEBRTC_USE_H264 -DWEBRTC_INITIALIZE_FFMPEG -DNO_STL -DWEBRTC_POSIX
