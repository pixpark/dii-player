...
#define PROFILE(msg) dii_rtc::ProfilerScope UNIQUE_VAR(msg)
...
#define PROFILE_DUMP_ALL(sev) \
  dii_rtc::Profiler::Instance()->ReportAllToLog(__FILE__, __LINE__, sev)
...
#define PROFILE_DUMP(sev, prefix) \
  dii_rtc::Profiler::Instance()->ReportToLog(__FILE__, __LINE__, sev, prefix)
...
#define PROFILE_START(msg) dii_rtc::Profiler::Instance()->StartEvent(msg)
#define PROFILE_STOP(msg) dii_rtc::Profiler::Instance()->StopEvent(msg)
