...
class FakeSSLCertificate : public dii_rtc::SSLCertificate {
 public:
  ...
  bool ComputeDigest(const std::string& algorithm,
    ...
    *length = dii_rtc::ComputeDigest(algorithm, data_.c_str(), data_.size(),
                                       digest, size);
    return (*length != 0);
  }
...
class FakeSSLIdentity : public dii_rtc::SSLIdentity {
 public:
