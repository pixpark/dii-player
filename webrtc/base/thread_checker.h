...
class SCOPED_LOCKABLE AnnounceOnThread {
 public:
  ...
  static bool IsCurrent(const dii_rtc::ThreadChecker* checker) {
...
//
//  private:
//   dii_rtc::Thread* network_thread_;
...
//   dii_rtc::ThreadChecker pacer_thread_checker_;
// };
//
...
//   class Encoder {
//    public:
//     dii_rtc::TaskQueue* Queue() { return encoder_queue_; }
//     void Encode() {
...
//
//    private:
//     dii_rtc::TaskQueue* const encoder_queue_;
...
//     // encoder_->Encode();
//     // Will work:
//     dii_rtc::scoped_ref_ptr<Encoder> encoder = encoder_;
//     encoder_->Queue()->PostTask([encoder] { encoder->Encode(); });
//   }
//
//  private:
//   dii_rtc::scoped_ref_ptr<Encoder> encoder_;
// }
...
#define RTC_DCHECK_RUN_ON(thread_like_object) \
  dii_rtc::internal::AnnounceOnThread thread_announcer(thread_like_object); \
  RTC_DCHECK(dii_rtc::internal::AnnounceOnThread::IsCurrent(thread_like_object))
