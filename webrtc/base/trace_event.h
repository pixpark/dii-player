...
#define TRACE_STR_COPY(str) \
    dii_media_kit::trace_event_internal::TraceStringWithCopy(str)
...
#define TRACE_ID_MANGLE(id) \
    dii_media_kit::trace_event_internal::TraceID::ForceMangle(id)
...
#define TRACE_EVENT_API_GET_CATEGORY_ENABLED \
    dii_media_kit::EventTracer::GetCategoryEnabled
...
//                    unsigned char flags)
#define TRACE_EVENT_API_ADD_TRACE_EVENT dii_media_kit::EventTracer::AddTraceEvent
...
#define INTERNAL_TRACE_EVENT_ADD(phase, category, name, flags, ...) \
    do { \
      ...
      if (*INTERNAL_TRACE_EVENT_UID(catstatic)) { \
        dii_media_kit::trace_event_internal::AddTraceEvent(          \
            phase, INTERNAL_TRACE_EVENT_UID(catstatic), name, \
            dii_media_kit::trace_event_internal::kNoEventId, flags, ##__VA_ARGS__); \
      } \
    } while (0)
...
#define INTERNAL_TRACE_EVENT_ADD_SCOPED(category, name, ...) \
    INTERNAL_TRACE_EVENT_GET_CATEGORY_INFO(category); \
    dii_media_kit::trace_event_internal::TraceEndOnScopeClose  \
        INTERNAL_TRACE_EVENT_UID(profileScope); \
    if (*INTERNAL_TRACE_EVENT_UID(catstatic)) { \
      dii_media_kit::trace_event_internal::AddTraceEvent(      \
          TRACE_EVENT_PHASE_BEGIN, \
          INTERNAL_TRACE_EVENT_UID(catstatic), \
          name, dii_media_kit::trace_event_internal::kNoEventId,       \
...
#define INTERNAL_TRACE_EVENT_ADD_WITH_ID(phase, category, name, id, flags, \
    ...
    do { \
      ...
      if (*INTERNAL_TRACE_EVENT_UID(catstatic)) { \
        ...
        dii_media_kit::trace_event_internal::TraceID trace_event_trace_id( \
