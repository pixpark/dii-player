...
//   int main() {
//     Foo foo;
//     cout << dii_rtc::Bind(&Foo::Test1, &foo)() << endl;
//     cout << dii_rtc::Bind(&Foo::Test2, &foo)() << endl;
//     cout << dii_rtc::Bind(&Foo::Test3, &foo, 3)() << endl;
//     cout << dii_rtc::Bind(&Foo::Test4, &foo, 7, 8.5f)() << endl;
//   }
//
...
//       invoker.AsyncInvoke(RTC_FROM_HERE,dii_rtc::Bind(&Bar::Test, this));
//     }
//   };
//
//   int main() {
//     dii_rtc::scoped_refptr<Bar> bar = new dii_rtc::RefCountedObject<Bar>();
//     auto functor = dii_rtc::Bind(&Bar::Test, bar);
//     bar = nullptr;
...
// dii_rtc::scoped_refptr<T>, i.e. types that implements nullary functions AddRef()
...
class MethodFunctor1 {
 ...
 private:
  MethodT method_;
  typename detail::PointerType<ObjectT>::type object_;
  typename dii_rtc::remove_reference<P1>::type p1_;
};
...
class MethodFunctor2 {
 ...
 private:
  ...
  typename detail::PointerType<ObjectT>::type object_;
  typename dii_rtc::remove_reference<P1>::type p1_;
  typename dii_rtc::remove_reference<P2>::type p2_;
};
...
class MethodFunctor3 {
 ...
 private:
  ...
  typename dii_rtc::remove_reference<P1>::type p1_;
  typename dii_rtc::remove_reference<P2>::type p2_;
  typename dii_rtc::remove_reference<P3>::type p3_;
};
...
class MethodFunctor4 {
 ...
 private:
  ...
  typename dii_rtc::remove_reference<P2>::type p2_;
  typename dii_rtc::remove_reference<P3>::type p3_;
  typename dii_rtc::remove_reference<P4>::type p4_;
};
...
class MethodFunctor5 {
 ...
 private:
  ...
  typename dii_rtc::remove_reference<P3>::type p3_;
  typename dii_rtc::remove_reference<P4>::type p4_;
  typename dii_rtc::remove_reference<P5>::type p5_;
};
...
class MethodFunctor6 {
 ...
 private:
  ...
  typename dii_rtc::remove_reference<P4>::type p4_;
  typename dii_rtc::remove_reference<P5>::type p5_;
  typename dii_rtc::remove_reference<P6>::type p6_;
};
...
class MethodFunctor7 {
 ...
 private:
  ...
  typename dii_rtc::remove_reference<P5>::type p5_;
  typename dii_rtc::remove_reference<P6>::type p6_;
  typename dii_rtc::remove_reference<P7>::type p7_;
};
...
class MethodFunctor8 {
 ...
 private:
  ...
  typename dii_rtc::remove_reference<P6>::type p6_;
  typename dii_rtc::remove_reference<P7>::type p7_;
  typename dii_rtc::remove_reference<P8>::type p8_;
};
...
class MethodFunctor9 {
 ...
 private:
  ...
  typename dii_rtc::remove_reference<P7>::type p7_;
  typename dii_rtc::remove_reference<P8>::type p8_;
  typename dii_rtc::remove_reference<P9>::type p9_;
};
