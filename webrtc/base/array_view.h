...
// std::vector, dii_rtc::Buffer, ...), but it's error-prone because the caller has
...
//
// Enter dii_rtc::ArrayView<T>. It contains a T pointer (to an array it doesn't
// own) and a count, and supports the basic things you'd expect, such as
// indexing and iteration. It allows us to write our function like this:
//
//   bool Contains17(dii_rtc::ArrayView<const int> arr) {
//     for (auto e : arr) {
//       if (e == 17)
//         return true;
//     }
...
//   Contains17(dii_rtc::ArrayView<int>(arr, size));  // pointer + size
...
class ArrayView final {
 public:
  ...
  // dii_rtc::Buffer to ArrayView<uint8_t> (with the same const behavior as
  // std::vector).
  template <typename U>
