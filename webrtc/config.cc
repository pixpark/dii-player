...
bool RtpExtension::IsSupportedForAudio(const std::string& uri) {
  return uri == dii_media_kit::RtpExtension::kAbsSendTimeUri ||
         uri == dii_media_kit::RtpExtension::kAudioLevelUri ||
         uri == dii_media_kit::RtpExtension::kTransportSequenceNumberUri;
}

bool RtpExtension::IsSupportedForVideo(const std::string& uri) {
  return uri == dii_media_kit::RtpExtension::kTimestampOffsetUri ||
         uri == dii_media_kit::RtpExtension::kAbsSendTimeUri ||
         uri == dii_media_kit::RtpExtension::kVideoRotationUri ||
         uri == dii_media_kit::RtpExtension::kTransportSequenceNumberUri ||
         uri == dii_media_kit::RtpExtension::kPlayoutDelayUri;
}
