...
class AudioManager {
 public:
  ...
  // Possible values are dii_media_kit::kLowLatencyModeDelayEstimateInMilliseconds and
  // dii_media_kit::kHighLatencyModeDelayEstimateInMilliseconds.
 ...
 private:
  ...
  dii_media_kit::ScopedSLObjectItf engine_object_;
