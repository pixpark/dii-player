...
AudioRecordJni::AudioRecordJni(AudioManager* audio_manager)
  ...
  JNINativeMethod native_methods[] = {
      ...
      reinterpret_cast<void*>(
          &dii_media_kit::AudioRecordJni::CacheDirectBufferAddress)},
      {"nativeDataIsRecorded", "(IJ)V",
      reinterpret_cast<void*>(&dii_media_kit::AudioRecordJni::DataIsRecorded)}};
  j_native_registration_ = j_environment_->RegisterNatives(
      "org/dii/webrtc/voiceengine/WebRtcAudioRecord", native_methods,
...
void JNICALL AudioRecordJni::CacheDirectBufferAddress(
  ...
  dii_media_kit::AudioRecordJni* this_object =
      reinterpret_cast<dii_media_kit::AudioRecordJni*> (nativeAudioRecord);
