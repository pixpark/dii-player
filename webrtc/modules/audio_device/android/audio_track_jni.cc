...
AudioTrackJni::AudioTrackJni(AudioManager* audio_manager)
  ...
  JNINativeMethod native_methods[] = {
      ...
      reinterpret_cast<void*>(
          &dii_media_kit::AudioTrackJni::CacheDirectBufferAddress)},
      {"nativeGetPlayoutData", "(IJ)V",
      reinterpret_cast<void*>(&dii_media_kit::AudioTrackJni::GetPlayoutData)}};
  j_native_registration_ = j_environment_->RegisterNatives(
      "org/dii/webrtc/voiceengine/WebRtcAudioTrack", native_methods,
...
void JNICALL AudioTrackJni::CacheDirectBufferAddress(
  ...
  dii_media_kit::AudioTrackJni* this_object =
      reinterpret_cast<dii_media_kit::AudioTrackJni*> (nativeAudioTrack);
