...
AudioManager::AudioManager()
  ...
  JNINativeMethod native_methods[] = {
      {"nativeCacheAudioParameters",
       "(IIZZZZZIIJ)V",
       reinterpret_cast<void*>(&dii_media_kit::AudioManager::CacheAudioParameters)}};
  j_native_registration_ = j_environment_->RegisterNatives(
      "org/dii/webrtc/voiceengine/WebRtcAudioManager", native_methods,
...
void JNICALL AudioManager::CacheAudioParameters(JNIEnv* env,
  ...
  dii_media_kit::AudioManager* this_object =
      reinterpret_cast<dii_media_kit::AudioManager*>(native_audio_manager);
