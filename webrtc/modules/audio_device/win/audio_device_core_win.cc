...
DWORD AudioDeviceWindowsCore::DoRenderThread()
{
    ...
    dii_rtc::SetCurrentThreadName("webrtc_core_audio_render_thread");
        ...
        while (keepPlaying)
        {
            ...
            for (uint32_t n = 0; n < n10msBuffers; n++)
            {
                ...
                if (_ptrAudioBuffer)
                {
                    ...
                    _UnLock();
                    int32_t nSamples =
                    _ptrAudioBuffer->RequestPlayoutData(_playBlockSize, _sndCardPlayDelay);
                    _Lock();
...
DWORD AudioDeviceWindowsCore::InitCaptureThreadPriority()
{
    ...
    dii_rtc::SetCurrentThreadName("webrtc_core_audio_capture_thread");
...
int AudioDeviceWindowsCore::SetDMOProperties()
{
    ...
    dii_rtc::scoped_refptr<IPropertyStore> ps;
    {
                                                       ...
                                                       int* index)
{
    ...
    *index = -1;
    for (UINT i = 0; i < count; i++)
    {
        ...
        dii_rtc::scoped_refptr<IMMDevice> device;
        {
