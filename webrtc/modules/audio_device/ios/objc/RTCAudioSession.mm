...
NSString * const kRTCAudioSessionErrorDomain = @"org.apollo_rtmp_live_kit.webrtc.RTCAudioSession";
...
- (void)lockForConfiguration {
  _crit.Enter();
  dii_rtc::AtomicOps::Increment(&_lockRecursionCount);
}
...
- (void)unlockForConfiguration {
  ...
  // unlock.
  if (_crit.TryEnter()) {
    dii_rtc::AtomicOps::Decrement(&_lockRecursionCount);
...
- (int)incrementActivationCount {
  ...
  return dii_rtc::AtomicOps::Increment(&_activationCount);
}

- (NSInteger)decrementActivationCount {
  RTCLog(@"Decrementing activation count.");
  return dii_rtc::AtomicOps::Decrement(&_activationCount);
}
...
- (BOOL)beginWebRTCSession:(NSError **)outError {
  ...
  dii_rtc::AtomicOps::Increment(&_webRTCSessionCount);
...
- (BOOL)endWebRTCSession:(NSError **)outError {
  ...
  dii_rtc::AtomicOps::Decrement(&_webRTCSessionCount);
