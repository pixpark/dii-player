...
AudioDeviceIOS::AudioDeviceIOS()
  ...
  thread_ = dii_rtc::Thread::Current();
...
int32_t AudioDeviceIOS::StartPlayout() {
  ...
  dii_rtc::AtomicOps::ReleaseStore(&playing_, 1);
  return 0;
}
...
int32_t AudioDeviceIOS::StopPlayout() {
  ...
  play_is_initialized_ = false;
  dii_rtc::AtomicOps::ReleaseStore(&playing_, 0);
  return 0;
}
...
int32_t AudioDeviceIOS::StartRecording() {
  ...
  dii_rtc::AtomicOps::ReleaseStore(&recording_, 1);
  return 0;
}
...
int32_t AudioDeviceIOS::StopRecording() {
  ...
  rec_is_initialized_ = false;
  dii_rtc::AtomicOps::ReleaseStore(&recording_, 0);
  return 0;
}
...
void AudioDeviceIOS::OnCanPlayOrRecordChange(bool can_play_or_record) {
  ...
  thread_->Post(RTC_FROM_HERE, this, kMessageTypeCanPlayOrRecordChange,
                new dii_rtc::TypedMessageData<bool>(can_play_or_record));
}
...
OSStatus AudioDeviceIOS::OnDeliverRecordedData(
  ...
  if (!dii_rtc::AtomicOps::AcquireLoad(&recording_))
    return result;
...
OSStatus AudioDeviceIOS::OnGetPlayoutData(AudioUnitRenderActionFlags* flags,
  ...
  // activated.
  if (!dii_rtc::AtomicOps::AcquireLoad(&playing_)) {
  ...
  if (num_frames != frames_per_buffer) {
    RTCLogWarning(@"Playing Expected %u frames but got %u",
                  static_cast<unsigned int>(frames_per_buffer),
                  static_cast<unsigned int>(num_frames));
...
void AudioDeviceIOS::OnMessage(dii_rtc::Message *msg) {
  switch (msg->message_id) {
    ...
    case kMessageTypeCanPlayOrRecordChange: {
      dii_rtc::TypedMessageData<bool>* data =
          static_cast<dii_rtc::TypedMessageData<bool>*>(msg->pdata);
