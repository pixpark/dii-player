      ...
      _CoUninitializeIsRequired(true)
{
    ...
    if (FAILED(hr))
    {
        ...
        if (hr == RPC_E_CHANGED_MODE)
        {
            ...
            //
            WEBRTC_TRACE(dii_media_kit::kTraceWarning, dii_media_kit::kTraceVideoCapture, _id,
...
int32_t DeviceInfoDS::Init()
{
    ...
    if (hr != NOERROR)
    {
        WEBRTC_TRACE(dii_media_kit::kTraceError, dii_media_kit::kTraceVideoCapture, _id,
...

{
                        ...
                        != 0))
                {
                    ...
                    if (index == static_cast<int>(deviceNumber))
                    {
                        ...
                        if (deviceNameLength > 0)
                        {
                            ...
                            if (convResult == 0)
                            {
                                WEBRTC_TRACE(dii_media_kit::kTraceError,
                                             dii_media_kit::kTraceVideoCapture, _id,
    ...
    if (deviceNameLength)
    {
        WEBRTC_TRACE(dii_media_kit::kTraceDebug, dii_media_kit::kTraceVideoCapture, _id, "%s %s",
            ...
            if (deviceUniqueIdUTF8Length > 0)
            {
                ...
                if (SUCCEEDED(hr))
                {
                                ...
                                deviceUniqueIdUTF8Length) == 0)
                    {
                        ...
                        if FAILED(hr)
                        {
                            WEBRTC_TRACE(dii_media_kit::kTraceError, dii_media_kit::kTraceVideoCapture,
...

{
    ...
    WEBRTC_TRACE(dii_media_kit::kTraceInfo, dii_media_kit::kTraceVideoCapture, _id,
    ...
    for (int32_t tmp = 0; tmp < count; ++tmp)
    {
        ...
        if (!FAILED(hr))
        {
            ...
            {
                WEBRTC_TRACE(dii_media_kit::kTraceDebug, dii_media_kit::kTraceVideoCapture, _id,
    ...
    for (int32_t tmp = 0; tmp < count; ++tmp)
    {
            ...
            && pmt->formattype == preferedVideoFormat)
        {
            ...
            else
            {
                ...
                WEBRTC_TRACE( dii_media_kit::kTraceWarning,
                             dii_media_kit::kTraceVideoCapture, _id,
                                      ...
                                      uint32_t productUniqueIdUTF8Length)
{
    *productUniqueIdUTF8 = '\0';
    ...
    if (!startPos)
    {
        ...
        WEBRTC_TRACE(dii_media_kit::kTraceError, dii_media_kit::kTraceVideoCapture, -1,
