...
class ECLiveH264VideoToolboxEncoder : public H264Encoder {
 public:
  ECLiveH264VideoToolboxEncoder();

  ~ECLiveH264VideoToolboxEncoder() override;
 ...
 private:
  ...
  dii_rtc::scoped_refptr<VideoFrameBuffer> GetScaledBufferOnEncode(
  ...
  int32_t height_;
  int32_t fps_;
  dii_rtc::CriticalSection quality_scaler_crit_;
