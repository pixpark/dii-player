...
class VCMEncodedFrame : protected EncodedImage {
 public:
  VCMEncodedFrame();
  explicit VCMEncodedFrame(const dii_media_kit::EncodedImage& rhs);
  ...
  */
  const dii_media_kit::EncodedImage& EncodedImage() const {
    return static_cast<const dii_media_kit::EncodedImage&>(*this);
  }
  /**
  ...
  *   Get frame type
  */
  dii_media_kit::FrameType FrameType() const { return _frameType; }
  /**
  *   Get frame rotation
  */
  ...
  */
  ...
  dii_media_kit::VideoCodecType _codec;
