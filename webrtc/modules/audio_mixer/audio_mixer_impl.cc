...
dii_rtc::scoped_refptr<AudioMixerImpl> AudioMixerImpl::Create() {
  return Create(std::unique_ptr<DefaultOutputRateCalculator>(
                    new DefaultOutputRateCalculator()),
                true);
}

dii_rtc::scoped_refptr<AudioMixerImpl>
...
dii_rtc::scoped_refptr<AudioMixerImpl> AudioMixerImpl::Create(
    std::unique_ptr<OutputRateCalculator> output_rate_calculator,
    bool use_limiter) {
  return dii_rtc::scoped_refptr<AudioMixerImpl>(
      new dii_rtc::RefCountedObject<AudioMixerImpl>(
