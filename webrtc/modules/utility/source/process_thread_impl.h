...
class ProcessThreadImpl : public ProcessThread {
 public:
  ...
  void PostTask(std::unique_ptr<dii_rtc::QueuedTask> task) override;
 ...
 private:
  ...
  dii_rtc::CriticalSection lock_;  // Used to guard modules_, tasks_ and stop_.
  ...
  std::unique_ptr<dii_rtc::PlatformThread> thread_;

  ModuleList modules_;
  std::queue<dii_rtc::QueuedTask*> queue_;
  bool stop_;
