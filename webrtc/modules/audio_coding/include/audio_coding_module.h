...
class AudioCodingModule {
 ...
 public:
  struct Config {
    ...
    Clock* clock;
    dii_rtc::scoped_refptr<AudioDecoderFactory> decoder_factory;
  };
  ...
  //
  virtual dii_rtc::Optional<CodecInst> SendCodec() const = 0;
  ...
  //
  virtual dii_rtc::Optional<uint32_t> PlayoutTimestamp() = 0;
