...
class VideoFrame {
 public:
  ...
  VideoFrame(const dii_rtc::scoped_refptr<dii_media_kit::VideoFrameBuffer>& buffer,
             uint32_t timestamp,
  ...
  // dii_media_kit::VideoFrame merge. If you need to write into the frame, create a
  ...
  // TODO(nisse): Deprecated. Should be deleted in the cricket::VideoFrame and
  // dii_media_kit::VideoFrame merge. Instead, create a VideoFrameBuffer and pass to
  ...
  // dii_media_kit::VideoFrame merge. Instead, use I420Buffer::Copy to make a copy of
  ...
  // TODO(nisse): Deprecated. Should be deleted in the cricket::VideoFrame and
  // dii_media_kit::VideoFrame merge. Instead, pass video_frame_buffer() and timestamps
  // to the constructor.
  ...
  // TODO(nisse): Deprecated. Should be deleted in the cricket::VideoFrame and
  // dii_media_kit::VideoFrame merge. When used with memset, consider using
  // dii_libyuv::I420Rect instead.
  ...
  // TODO(nisse): After the cricket::VideoFrame and dii_media_kit::VideoFrame
  ...
  // TODO(nisse): Deprecated. Should be deleted in the cricket::VideoFrame and
  // dii_media_kit::VideoFrame merge. The intention is that video_frame_buffer() never
  // should return nullptr. To handle potentially uninitialized or non-existent
  // frames, consider using dii_rtc::Optional. Otherwise, IsZeroSize() can be
  ...
  const dii_rtc::scoped_refptr<dii_media_kit::VideoFrameBuffer>& video_frame_buffer()
      const;
 ...
 private:
  ...
  dii_rtc::scoped_refptr<dii_media_kit::VideoFrameBuffer> video_frame_buffer_;
  uint32_t timestamp_;
